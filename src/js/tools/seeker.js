...
UI.setCookie = function (n, v) {
  if (window.localStorage) window.localStorage.setItem(n, v);
    ...
    document.cookie =
      n + '=' + v + '; expires=Fri, 31 Dec 9999 23:59:59 GMT; path=/';
  return v;
};
...
UI.eventMoniter = function () {
  ...
  $('#output').on('mouseout', '> span .line', function (e) {
