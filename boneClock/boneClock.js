...
togglePathButton.addEventListener('click', () => {
  frame.setAttribute('d', isNewPath ? original_frame_path : new_frame_path);
  blocks.forEach(block => {
    block.setAttribute('d', isNewPath ? original_block_path : new_block_path);
  });
  hands.forEach(hand => {
