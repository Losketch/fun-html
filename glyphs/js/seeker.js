...
Seeker.blockFlagMap = {'#': 0x0001, 'A': 0x0002, 'B': 0x0004, 'C': 0x0008, 'D': 0x0010, 'E': 0x0020, 'F': 0x0040, 'G': 0x0080, 'H': 0x0090, 'I': 0x0100, 'X': 0x2000, 'Y': 0x4000, 'Z': 0x8000};
Seeker.blockMap = {1: 0x0001, 2: 0x0002, 3: 0x0004, 4: 0x0008, 5: 0x0010, 6: 0x0020, 7: 0x0040, 8: 0x0080, 9: 0x0090, 10: 0x0100, 28: 0x2000, 29: 0x2000, 30: 0x4000};
...
UI.blockClasses = {1: 'BSC', 2: 'ExA', 3: 'ExB', 4: 'ExC', 5: 'ExD', 6: 'ExE', 7: 'ExF', 8: 'ExG', 9: 'ExH', 10: 'ExI', 27: 'CMP', 28: 'CMP', 29: 'CMP', 30: 'SUP', 31: 'SUP'};
...
UI.setResult = function(founds, i, force) {
	...
	var msg = force ? '' : '<span style="color:red">(基本区)</span> ';
