...
window.addEventListener('devicemotion', ev => {
  ...
  document.body.style.setProperty('--deg', ((accelerationValueScale = (accelerationValue = Math.sqrt(acceleration.x ** 2 + acceleration.y ** 2 + acceleration.z ** 2)) * scale) <= 180 ? accelerationValueScale : 180) + 'deg')
...
const originalFramePath = 'M18 0v40c0 21-2 49-18 69l9 6c16-20 19-47 19-71h85V0Zm10 10h74v24H28Z';
const newFramePath = 'm102 0-4 5H27L17 1v38c0 26-2 53-16 75l2 1c20-21 22-51 22-74h74v8h1c3 0 7-2 7-3V11l6-3zM25 9h74v28H25Z';
